...
No public APIs have been documented yet. The previously listed CNATRA "API" reference is an Aviation Preflight Indoctrination training video library, not a programmatic API. Check back for updates.

## Common Properties

- [Website](https://www.navy.mil/)
- [Website](https://www.cnatra.navy.mil/)
